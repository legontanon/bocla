...
int main() {
    ...
    while (1) {
        ...
        // Optional: Watchdog or heartbeat logic here
        // The audio playback is handled by DMA interrupts
        // The buttons are handled by PIO interrupts
        // The LED is handled by the repeating timer
    }
}
